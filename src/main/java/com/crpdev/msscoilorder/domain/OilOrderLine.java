...
public class OilOrderLine extends BaseEntity {
    ...
    @Builder
    public OilOrderLine(UUID id, Integer version, Timestamp createDate, Timestamp lastModifiedDate, OilOrder oilOrder, UUID oilId, Integer orderQuantity, Integer quantityAllocated) {
